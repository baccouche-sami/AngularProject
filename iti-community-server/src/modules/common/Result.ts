...
namespace bad {
     ...
     */
    export const forbidden: BadShortcut<"FORBIDDEN"> = <TValue>(value?: TValue) => bad("FORBIDDEN", value);

    /**
     * The current actor is not authenticated, or its authentication cannot be verified.
     */
    export const notAuthorized: BadShortcut<"NOT_AUTHORIZED"> = <TValue>(value?: TValue) => bad("NOT_AUTHORIZED", value);

    /**
     * The requested entity was not found
     */
    export const notFound: BadShortcut<"NOT_FOUND"> = <TValue>(value?: TValue) => bad("NOT_FOUND", value);

    /**
     * Validation of the input parameters has failed.
     */
    export const validationFailed: BadShortcut<"VALIDATION_FAILED"> = <TValue>(value?: TValue) => bad("VALIDATION_FAILED", value);
}
